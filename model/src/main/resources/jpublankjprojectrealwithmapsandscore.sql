...
(8, 'MAP8', '  BHHB             BB2BHHB   BHHB    V    BB  V4 V   BB B BKVB VB V  BB      V  VB VB BC   BB BHHB  BHB BB   V  LB     B  BB  BHHB  BB  B   B3       BHHHB   BHHBBP PBV          BHBBBHB     '),
(9, 'MAP9', 'BHHBHHHBHHHHHBHHBHHBV  B         V  B LVBHB          B     VV  BHHHHHHHBB      VV          B     BVBV  B     C         VBHB    B      B    VV2   B  BHB  HBBBHHBV  V  B    B3  B   VV  V1 V  K V   V   VV  V  V4   V   V   VBHHBHHBHHHHBHHHBHHHB'),
(10, 'TEST', 'BVHPL\n1234 \nCO   '),
